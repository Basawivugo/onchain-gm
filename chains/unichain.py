...
class Unichain:
    """Unichain chain implementation."""
    
    # Chain configuration
    NAME = "Unichain"
    CHAIN_ID = 130
    RPC_URL = os.getenv("UNICHAIN_RPC_URL", "https://mainnet.unichain.org")
    GM_CONTRACT = "0x34287F1ceF9B009195B89801Ae4e2DFE708719aB"
    EXPLORER_URL = "https://uniscan.xyz/tx/0x{tx_hash}"
    GM_FUNCTION = "0x5011b71c"  # GM function signature
    MIN_VALUE = 0.000029  # ETH value to send with transaction
    GAS_LIMIT = 300000
    
    def __init__(self):
        """Initialize the Unichain chain handler."""
