"""MegaETH chain implementation for GM sending."""
import os
import asyncio
...
class MegaETHChain:
    ...
    EXPLORER_URL = "https://www.megaexplorer.xyz/tx/0x{tx_hash}"
    GM_FUNCTION = "0x5011b71c"  # GM function signature
    MIN_VALUE = 0.0000001  # ETH value to send with transaction
    GAS_LIMIT = 300000
    
    def __init__(self):
        """Initialize the MegaETH chain handler."""
