"""Unichain chain implementation for GM sending."""
import os
import asyncio
...
class Inkchain:
    """Inkchain chain implementation."""
    
    # Chain configuration
    NAME = "Inkchain"
    CHAIN_ID = 57073
    RPC_URL = os.getenv("INKCHAIN_RPC_URL", "https://rpc-qnd.inkonchain.com")
    GM_CONTRACT = "0x34287F1ceF9B009195B89801Ae4e2DFE708719aB"
    EXPLORER_URL = "https://explorer.inkonchain.com/tx/0x{tx_hash}"
    GM_FUNCTION = "0x5011b71c"  # GM function signature
    MIN_VALUE = 0.000029  # ETH value to send with transaction
    GAS_LIMIT = 300000
    
    def __init__(self):
        """Initialize the InkChain chain handler."""
