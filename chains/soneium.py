...
class Soneium:
    """Soneium chain implementation."""
    
    # Chain configuration
    NAME = "Soneium"
    CHAIN_ID = 1868
    RPC_URL = os.getenv("SONEIUM_RPC_URL", "https://rpc.soneium.org")
    GM_CONTRACT = "0x34287F1ceF9B009195B89801Ae4e2DFE708719aB"
    EXPLORER_URL = "https://soneium.blockscout.com/tx/0x{tx_hash}"
    GM_FUNCTION = "0x5011b71c"  # GM function signature
    MIN_VALUE = 0.000029  # ETH value to send with transaction
    GAS_LIMIT = 300000
    
    def __init__(self):
        """Initialize the Soneium chain handler."""
